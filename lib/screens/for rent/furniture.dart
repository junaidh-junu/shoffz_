...
class furnitureRental extends StatefulWidget {
  @override
  _furnitureRentalState createState() => _furnitureRentalState();
}

class _furnitureRentalState extends State<furnitureRental> {
